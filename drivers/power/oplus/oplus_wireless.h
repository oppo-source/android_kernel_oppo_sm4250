...
#define WPC_CHARGE_CURRENT_DEFAULT							250
#else
...
struct wpc_chg_param_t{
	...
	int svooc_target_ichg_cold_fastchg_ma;
	int svooc_target_ichg_little_cold_fastchg_ma;
	...
	int svooc_target_ichg_cool_fastchg_ma;
	...
	int svooc_target_ichg_normal_region1_fastchg_ma;
	...
	int svooc_target_ichg_normal_region2_fastchg_ma;
	...
	int svooc_target_ichg_normal_region3_fastchg_ma;
	...
	int svooc_target_ichg_warm_fastchg_ma;
